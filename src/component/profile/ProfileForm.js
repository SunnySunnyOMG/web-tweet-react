...
import profileCover from '../../img/upload.png'
...
class ProfileForm extends Component {
  ...
  handleAvatarChange = e => {
      ...
      uplaodImage(file).then(url => this.setState({
        avatarUrl: url
      }))
  }
    ...
    return (
      <div className="profile">
        <div className="relative img-edit">
          ...
          <img onClick={() => this.inputRef.current.click()} className="avatar-upload" src={profileCover} alt="upload-img" />
        </div>
